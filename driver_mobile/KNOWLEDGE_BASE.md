...
| `frontend/src/roles/driver/pages/TripDetails.jsx` | Driver Trip Details page with live browser `navigator.geolocation` tracking, continuous API sync (`POST /api/driver/location`), POD/Weighbridge upload rules, trip pipeline stage backward locking, auto-generated MongoDB Invoice and Toll Fee Receipt bill view modals. |
