      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-8 overflow-y-auto custom-scrollbar">
          ...
          <div className="inline-flex items-center p-1 bg-white border border-slate-200 rounded-full mb-8 shadow-sm">
            ...
            <button className="px-6 py-2.5 text-sm font-bold text-slate-600 hover:text-slate-900 rounded-full transition-colors">System Health</button>
            <button className="px-6 py-2.5 text-sm font-bold text-slate-600 hover:text-slate-900 rounded-full transition-colors">Audit Logs</button>
          </div>
