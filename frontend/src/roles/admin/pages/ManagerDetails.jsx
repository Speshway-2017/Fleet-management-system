      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-8 overflow-y-auto custom-scrollbar">
          ...
          <div className="inline-flex items-center p-1 bg-white border border-slate-200 rounded-full mb-8 shadow-sm">
            ...
            <Link to={`/admin/fleet-managers/edit/${id}`} className="px-6 py-2.5 text-sm font-bold text-slate-600 hover:text-slate-900 rounded-full transition-colors">Edit Manager</Link>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to={`/admin/fleet-managers/edit/${id}`} className="flex items-center gap-2 px-5 py-2.5 text-sm font-bold text-white bg-[#A14000] rounded-lg shadow-sm hover:bg-[#8a3700] transition-colors">
