...
export default function Performance({ setActiveTab }) {
  ...
  return (
    <div className="bg-bg-page min-h-screen flex flex-col font-sans">
      ...
      <section className="bg-white py-8 sm:py-12 px-4 sm:px-6 md:px-8 border-b border-border-custom text-center">
        <div className="max-w-6xl mx-auto space-y-3 flex flex-col items-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-secondary font-display tracking-tight leading-none">
            Fleet Performance
          </h2>
      ...
      <section className="py-6 sm:py-10 px-4 sm:px-6 md:px-8 bg-bg-page">
        <div className="max-w-6xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {/* Card 1: Total Organizations */}
          <div className="bg-[#FFDBCC] rounded-3xl p-4 sm:p-6 flex flex-col justify-between shadow-sm relative overflow-hidden h-32 sm:h-36 md:h-40">
            <div className="flex justify-between items-start">
              <span className="text-[9px] sm:text-[10px] font-bold text-body uppercase tracking-wider font-display leading-tight pr-1">Total Orgs</span>
              <div className="h-7 w-7 sm:h-9 sm:w-9 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-600 shrink-0">
            ...
            <div className="mt-auto space-y-0.5">
              <span className="text-xl sm:text-3xl font-extrabold font-display text-heading tracking-tight">1,284</span>
              <div className="flex items-center gap-1 text-[8.5px] sm:text-[10px] font-bold text-emerald-600">
          ...
          <div className="bg-[#FFDBCC] rounded-3xl p-4 sm:p-6 flex flex-col justify-between shadow-sm relative overflow-hidden h-32 sm:h-36 md:h-40">
            <div className="flex justify-between items-start">
              <span className="text-[9px] sm:text-[10px] font-bold text-body uppercase tracking-wider font-display leading-tight pr-1">Fleet Managers</span>
              <div className="h-7 w-7 sm:h-9 sm:w-9 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-600 shrink-0">
                <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
            ...
            <div className="mt-auto space-y-0.5">
              <span className="text-xl sm:text-3xl font-extrabold font-display text-heading tracking-tight">347</span>
              <div className="flex items-center gap-1 text-[8.5px] sm:text-[10px] font-bold text-emerald-600">
          ...
          <div className="bg-[#FFDBCC] rounded-3xl p-4 sm:p-6 flex flex-col justify-between shadow-sm relative overflow-hidden h-32 sm:h-36 md:h-40">
            <div className="flex justify-between items-start">
              <span className="text-[9px] sm:text-[10px] font-bold text-body uppercase tracking-wider font-display leading-tight pr-1">Platform Uptime</span>
              <div className="h-7 w-7 sm:h-9 sm:w-9 rounded-xl bg-amber-500/10 flex items-center justify-center text-secondary shrink-0">
                <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
            ...
            <div className="mt-auto space-y-0.5">
              <span className="text-xl sm:text-3xl font-extrabold font-display text-heading tracking-tight">99.8%</span>
              <div className="flex items-center gap-1 text-[8.5px] sm:text-[10px] font-bold text-emerald-600">
          ...
          <div className="bg-[#FFDBCC] rounded-3xl p-4 sm:p-6 flex flex-col justify-between shadow-sm relative overflow-hidden h-32 sm:h-36 md:h-40">
            <div className="flex justify-between items-start">
              <span className="text-[9px] sm:text-[10px] font-bold text-body uppercase tracking-wider font-display leading-tight pr-1">Org Satisfaction</span>
              <div className="h-7 w-7 sm:h-9 sm:w-9 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-600 shrink-0">
                <svg className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5">
            ...
            <div className="mt-auto space-y-0.5">
              <span className="text-xl sm:text-3xl font-extrabold font-display text-heading tracking-tight">94.2%</span>
              <div className="flex items-center gap-1 text-[8.5px] sm:text-[10px] font-bold text-emerald-600">
      ...
      {/* 4. Charts Block */}
      <section className="pb-10 sm:pb-16 px-4 sm:px-6 md:px-8 bg-bg-page">
        <div className="max-w-6xl mx-auto space-y-6 sm:space-y-8">
          {/* Card 5: Weekly Platform Activity (Full Width) */}
          <div className="bg-white rounded-3xl border border-border-custom p-5 sm:p-8 space-y-6 sm:space-y-8 shadow-sm">
            ...
            <div className="relative h-64 w-full flex items-end justify-between pt-6 border-b border-border-custom/80 pb-2">
              ...
              {/* Bars container */}
              <div className="relative z-10 w-full h-full flex items-end justify-around px-2 sm:px-8 overflow-x-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="bg-white rounded-3xl border border-border-custom p-5 sm:p-8 space-y-6 sm:space-y-8 shadow-sm">
              ...
              <div className="relative h-64 w-full flex items-end justify-between pt-6 border-b border-border-custom/80 pb-2">
                ...
                {/* Bars container */}
                <div className="relative z-10 w-full h-full flex items-end justify-around px-2 sm:px-4 overflow-x-auto">
            ...
            <div className="bg-white rounded-3xl border border-border-custom p-5 sm:p-8 space-y-6 sm:space-y-8 shadow-sm flex flex-col justify-between">
              <div className="space-y-1">
