...
export default function DriverProfilePage() {
  ...
  const handleUnassignVehicle = () => {
    ...
    if (savedDrivers) {
      const driversList = JSON.parse(savedDrivers);
      const updatedDriversList = driversList.map(d => d.id === driver.id ? updatedDriver : d);
      localStorage.setItem("fleet_drivers", JSON.stringify(updatedDriversList));
    }
    ...
    if (savedVehicles) {
      ...
      localStorage.setItem("fleet_vehicles", JSON.stringify(updatedVehiclesList));
    }
    ...
    <div className="min-h-screen flex bg-[#F5F7FB] font-nunito text-[#1E293B]">
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-screen">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-8 custom-scrollbar space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-[#E7EAF0] pb-6">
